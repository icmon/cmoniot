<!-- BEGIN PAGE MODALS -->
<div class="modal modal-blur fade" id="modal-report-alarm" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Add New alarm Config</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form class="card card-md" action="<?php echo base_url('settings/alarm/insertdb');?>" method="post"
