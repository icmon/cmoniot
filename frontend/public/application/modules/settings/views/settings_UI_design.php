                             ...
                             <div class="col-xl-4">
                                 <div class="row">
                                     <div class="col-md-6 col-xl-12">
                                             ...
                                             <div class="row g-2">
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         ...
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/beautiful-blonde-woman-relaxing-with-a-can-of-coke-on-a-tree-stump-by-the-beach.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         ...
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/brainstorming-session-with-creative-designers.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck" type="checkbox" value="3"
                                                             class="form-imagecheck-input" />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/finances-us-dollars-and-bitcoins-currency-money.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck" type="checkbox" value="4"
                                                             class="form-imagecheck-input" checked />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/group-of-people-brainstorming-and-taking-notes-2.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck" type="checkbox" value="5"
                                                             class="form-imagecheck-input" />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/blue-sofa-with-pillows-in-a-designer-living-room-interior.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck" type="checkbox" value="6"
                                                             class="form-imagecheck-input" />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/home-office-desk-with-macbook-iphone-calendar-watch-and-organizer.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck-radio" type="radio" value="1"
                                                             class="form-imagecheck-input" />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/group-of-people-sightseeing-in-the-city.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck-radio" type="radio" value="2"
                                                             class="form-imagecheck-input" checked />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/color-palette-guide-sample-colors-catalog-.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck-radio" type="radio" value="3"
                                                             class="form-imagecheck-input" />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/stylish-workplace-with-computer-at-home.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck-radio" type="radio" value="4"
                                                             class="form-imagecheck-input" checked />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/pink-desk-in-the-home-office.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck-radio" type="radio" value="5"
                                                             class="form-imagecheck-input" />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/young-woman-sitting-on-the-sofa-and-working-on-her-laptop.jpg"
                                                 ...
                                                 <div class="col-6 col-sm-4">
                                                     <label class="form-imagecheck mb-2">
                                                         <input name="form-imagecheck-radio" type="radio" value="6"
                                                             class="form-imagecheck-input" />
                                                         <span class="form-imagecheck-figure">
                                                             <img src="<?php echo base_url('assets');?>/static/photos/coffee-on-a-table-with-other-items.jpg"
                                         ...
                                         <div class="mb-3">
                                             <label class="form-label">Color Input Radio</label>
                                             <div class="row g-2">
                                                 <div class="col-auto">
                                                     <label class="form-colorinput">
                                                 ...
                                                 <div class="col-auto">
                                                     <label class="form-colorinput">
                                                         <input name="color-rounded" type="radio" value="green"
                                                             class="form-colorinput-input" />
                                                         <span
                                                             class="form-colorinput-color bg-green rounded-circle"></span>
                                                     </label>
                                                 </div>
                                             </div>
                                         </div>
                                     ...
                                     <div class="col-md-6 col-xl-12">
                                             ...
                                             <div class="form-selectgroup">
                                                 ...
                                                 <label class="form-selectgroup-item">
                                                     ...
                                                     <input type="checkbox" name="name" value="cloud"
                                                         class="form-selectgroup-input">
                                                     <span class="form-selectgroup-label">
                                                         <!-- Download SVG icon from http://tabler.io/icons/icon/cloud -->
                                                         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                             viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                             stroke-width="2" stroke-linecap="round"
                                                             stroke-linejoin="round" class="icon icon-3">
                                             ...
                                             <div class="form-selectgroup">
                                                 ...
                                                 <label class="form-selectgroup-item">
                                                     ...
                                                     <input type="radio" name="icons" value="square"
                                                         class="form-selectgroup-input">
                                                     <span class="form-selectgroup-label">
                                                         <!-- Download SVG icon from http://tabler.io/icons/icon/square -->
                                                         <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                             viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                             stroke-width="2" stroke-linecap="round"
                                                             stroke-linejoin="round" class="icon me-1 icon-3">
                                                     ...
                                                     <div class="form-selectgroup-label d-flex align-items-center p-3">
                                                         ...
                                                         <div
                                                             ...
                                                             <div>
                                                                 ...
                                                                 <div class="text-secondary">VP Product Management
                                                                 </div>
                                                             </div>
                                                         </div>
                                                     </div>
                                         ...
                                         <div class="mb-3">
                                             ...
                                             <div class="btn-group w-100" role="group">
                                                 ...
                                                 <label for="btn-radio-dropdown-1" type="button" class="btn">Option
                                                     1</label>

                                                 <input type="radio" class="btn-check" name="btn-radio-dropdown"
                                                     id="btn-radio-dropdown-2" autocomplete="off">

                                                 <label for="btn-radio-dropdown-2" type="button" class="btn">Option
                                                     2</label>
...
&lt;/span&gt;">Tessie Curzon</option>
                                         ...
                                         <div class="mb-3">
                                             ...
                                             <select class="form-select mb-3 is-valid" id="select-countries-valid"
                                                 value="">
                                             ...
                                             <select class="form-select is-invalid" id="select-countries-invalid"
                                                 value="">
             ...
             <div class="col-md-6">
                 <div class="card">
                     <div class="card-body">
                         ...
                         <p class="card-subtitle">The version of Node.js that is used in the Build Step and for
