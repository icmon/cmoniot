...
$config['sess_cookie_name'] = 'ci_session_cmon';
$config['sess_expiration'] = 31536000000;
$config['sess_save_path'] = BASEPATH.'/log/ci_session_cmon'; // system\log\ci_session_cmon
$config['sess_match_ip'] = FALSE;
$config['sess_time_to_update'] = 31536000000;
$config['sess_regenerate_destroy'] = FALSE;


// $config['sess_driver'] = 'redis'; // Use Redis as the session driver
// $config['sess_cookie_name'] = 'ci_session'; // Session cookie name
// $config['sess_expiration'] = 31536000000; // Session expiration time (in seconds)
// $config['sess_save_path'] = 'tcp://127.0.0.1:6379'; // Redis server connection details
// $config['sess_match_ip'] = FALSE; // Whether to match the user's IP address
// $config['sess_time_to_update'] = 31536000000; // How often to regenerate session ID (in seconds)
// $config['sess_regenerate_destroy'] = FALSE; // Whether to destroy session data on regeneration


// echo 'BASEPATH=>'.BASEPATH; die();
