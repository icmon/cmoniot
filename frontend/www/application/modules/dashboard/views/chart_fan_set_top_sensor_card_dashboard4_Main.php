<?php 
    ...
    if ($bucket == null) { $bucket =$mqtt_bucket;  }
?>
<style>
.text-green {
...
#chart_task_data {
    width: 98%;
    height: 60%; /*145px; */ /* match chart height */
    position: relative;
    max-width: 98%;
    margin: 0 auto;
    font-family: inherit;
...
/* Optional: styling for tooltip */
/* ApexCharts tooltips are internally styled, but you can override if needed */
.apexcharts-tooltip {
    font-family: inherit;
    font-size: 0.85rem;
}

/* You can also prevent overflow issues */
#chart_task_data svg {
    overflow: visible;
}
</style>
...
<?php ####################### ?>
<?php ####################### ?>
 <div class="container-fluid" style="flex: 7;">
    <div class="row">
        <!-- Chart Column -->
                        ...
                        <div id="podium<?php echo $m;?>-status">
                            <div class="row g-3 align-items-end mb-2 center">
                                ...
                                <div class="col-auto d-flex align-items-end">
                                    <a href="<?php echo base_url('settings/device/deviceactive').'?bucket='.$bucket.'&mqtt_id='.$mqtt_id ; ?>"
                                        target="_blank">
