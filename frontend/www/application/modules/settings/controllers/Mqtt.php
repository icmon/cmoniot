...
class Mqtt extends MX_Controller {
	...
	public function index(){
        ...
        public function insert(){
                $input=@$this->input->post(); 
                if($input==null){$input=@$this->input->get();} 
                $ListSelect = array("title" => 'edit Mqtt');
		$data = array("ListSelect" => $ListSelect);
		$data['content_view'] = 'settings/mqtt/mqttadd';
		$this->load->view('template/template',$data);
        } 
        ...
        public function detail(){
                ...
                $ListSelect = array("title" => 'edit Mqtt');
		$data = array("ListSelect" => $ListSelect);
		$data['content_view'] = 'settings/mqtt/detail';
		$this->load->view('template/template',$data);
        } 
        public function edit(){
                ...
                $ListSelect = array("title" => 'edit Mqtt');
		$data = array("ListSelect" => $ListSelect);
		$data['content_view'] = 'settings/mqtt/mqttedit';
		$this->load->view('template/template',$data);
        } 
