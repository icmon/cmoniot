...
export class SettingsController {
  ...
  /*********************************/ 
  // http://192.168.1.59:3003/v1/settings/sendemail?to=icmon0955@gmail.com&subject=test&content=Cmon%20Alarm%201
 @HttpCode(200)
  //@AuthUserRequired()
  //@UseGuards(AuthGuardUser)
  @ApiOperation({ summary: 'list scheduledevice' })
 ...
 if (schedule_id=="" || schedule_id=="undefined" || schedule_id==undefined) {
  ...
  /*******************/
  // http://localhost:3003/v1/settings/schedulelist
  @HttpCode(200)
  //@AuthUserRequired()
  //@UseGuards(AuthGuardUser)
  @Get('schedulelist')
...
/********create_deviceactionuser**********/ 
  ...
  // http://localhost:3003/v1/settings/listalarmdevicepage?alarm_action_id=1
  // http://localhost:3003/v1/settings/listalarmeventdevicepage?alarm_action_id=1
  @HttpCode(200)
  //@AuthUserRequired()
  //@UseGuards(AuthGuardUser)
 ...
 if (alarm_action_id=="" || alarm_action_id=="undefined" || alarm_action_id==undefined) {
  ...
  @Get('alarmdevicestatusV1')
  async alarm_device_status_V1(
      @Res() res: Response,
      @Query() query: any,
      @Headers() headers: any,
      @Param() params: any,
      ...
      for (const [key, va] of Object.entries(ResultData)) { 
        ...
        var action_name:any=ResultData[key].action_name; 
            ...
            var device_data: any = await this.settingsService.device_list_paginate_alarm_device_event(filter1);   
            var device_event_control:any = []; 
            for (const [key, val] of Object.entries(device_data)) {     
                      var device_id:any = device_data[key].device_id;
                      var mqtt_id:any = device_data[key].mqtt_id;
                      var setting_id:any = device_data[key].setting_id;
                      var alarm_action_id:any = device_data[key].alarm_action_id;
                      var type_id:any = device_data[key].type_id;
                      var device_name:any = device_data[key].device_name;
                      var hardware_id:any = device_data[key].hardware_id; 
                      var time_life:any = device_data[key].time_life;
                      var period:any = device_data[key].period;
                      var work_status:any = device_data[key].work_status;
                      var max:any = device_data[key].max;
                      var min:any = device_data[key].min;
                      var measurement:any = device_data[key].measurement;
                      var sn:any = device_data[key].sn;
                      var oid:any = device_data[key].oid;
                      var model:any = device_data[key].model;
                      var vendor:any = device_data[key].vendor;
                      var comparevalue:any = device_data[key].comparevalue;
                      var status:any = device_data[key].status;
                      var unit:any = device_data[key].unit;
                      var action_id:any = device_data[key].action_id;
                      var status_alert_id:any = device_data[key].status_alert_id;
                      var device_org:any = device_data[key].device_org;
                      var device_bucket:any = device_data[key].device_bucket;
                      var type_name:any = device_data[key].type_name;
                      var location_name:any = device_data[key].location_name;
                      var mqtt_name:any = device_data[key].mqtt_name;
                      var mqtt_org:any = device_data[key].mqtt_org;
                      var mqtt_bucket:any = device_data[key].mqtt_bucket;
                      var mqtt_envavorment:any = device_data[key].mqtt_envavorment;
                      var mqtt_host:any = device_data[key].mqtt_host;
                      var mqtt_port:any = device_data[key].mqtt_port;
                      var mqtt_device_name:any = device_data[key].mqtt_device_name;
                      var mqtt_status_over_name:any = device_data[key].mqtt_status_over_name;
                      var mqtt_status_data_name:any = device_data[key].mqtt_status_data_name;
                      var mqtt_act_relay_name:any = device_data[key].mqtt_act_relay_name;
                      var mqtt_control_relay_name:any = device_data[key].mqtt_control_relay_name;
                      var action_name:any = device_data[key].action_name; 
                      var mqtt_data_value:any = device_data[key].mqtt_data_value;
                      var mqtt_data_control:any = device_data[key].mqtt_data_control;
                      var mqtt_control_on:any = device_data[key].mqtt_control_on;
                      var mqtt_control_off:any = device_data[key].mqtt_control_off;
                      var mqttrs:any = await this.mqttService.getdevicedataAll(mqtt_data_value); 
                      var configdata:any = device_data[key].configdata;
                      ...
                      var mqtt_objt_data = Object.values(obj);
                      var mqtt_count:any=mqtt_objt_data.length;
                      var mqtt_status_data_name = device_data[key].mqtt_status_data_name;
                      let obj2: any = [];
                      try {
                        obj2 = JSON.parse(mqtt_status_data_name);
                      } catch (e) {
                ...
                /******************/
                var status_warning:any = device_data[key].status_warning;
                var recovery_warning:any = device_data[key].recovery_warning;
                var status_alert:any = device_data[key].status_alert;
                var recovery_alert:any = device_data[key].recovery_alert; 
                /******************/
                ...
                /******************/    
                var email_alarm:any = device_data[key].email_alarm;
                var line_alarm:any = device_data[key].line_alarm;
                var telegram_alarm:any = device_data[key].telegram_alarm;
                var sms_alarm:any = device_data[key].sms_alarm;
                var nonc_alarm:any = device_data[key].nonc_alarm;
                var event:any = device_data[key].event;
                /******************/        
                device_event_control.push({
                  ...device_data[key],
                  ...merged, 
                  timestamp,
                  // merged,
            ...
            /*****************************device_event2**************************************************/   
            var count_device_event: any = await this.settingsService.alarm_device_id_event_count(filter1);     
            var device_event: any = await this.settingsService.device_list_paginate_active_alarm_device(filter1);  
            var device_event2:any = []; 
            for (const [key, val] of Object.entries(device_event)) {     
                      var device_id:any = device_event[key].device_id;
                      var alarm_action_name:any = device_event[key].action_name;
                      var alarm_event:any = device_event[key].event;
                      var alarm_status:any = device_event[key].status;
                      var mqtt_id:any = device_event[key].mqtt_id;
                      var setting_id:any = device_event[key].setting_id;
                      var alarm_action_id:any = device_event[key].alarm_action_id;
                      var type_id:any = device_event[key].type_id;
                      var device_name:any = device_event[key].device_name;
                      var hardware_id:any = device_event[key].hardware_id; 
                      var time_life:any = device_event[key].time_life;
                      var alarm_time_life:any = device_event[key].time_life;
                      var period:any = device_event[key].period;
                      var work_status:any = device_event[key].work_status;
                      var max:any = device_event[key].max;
                      var min:any = device_event[key].min;
                      var measurement:any = device_event[key].measurement;
                      var sn:any = device_event[key].sn;
                      var oid:any = device_event[key].oid;
                      var model:any = device_event[key].model;
                      var vendor:any = device_event[key].vendor;
                      var comparevalue:any = device_event[key].comparevalue;
                      var status:any = device_event[key].status;
                      var unit:any = device_event[key].unit;
                      var action_id:any = device_event[key].action_id;
                      var status_alert_id:any = device_event[key].status_alert_id;
                      var device_org:any = device_event[key].device_org;
                      var device_bucket:any = device_event[key].device_bucket;
                      var type_name:any = device_event[key].type_name;
                      var location_name:any = device_event[key].location_name;
                      var mqtt_name:any = device_event[key].mqtt_name;
                      var mqtt_org:any = device_event[key].mqtt_org;
                      var mqtt_bucket:any = device_event[key].mqtt_bucket;
                      var mqtt_envavorment:any = device_event[key].mqtt_envavorment;
                      var mqtt_host:any = device_event[key].mqtt_host;
                      var mqtt_port:any = device_event[key].mqtt_port;
                      var mqtt_device_name:any = device_event[key].mqtt_device_name;
                      var mqtt_status_over_name:any = device_event[key].mqtt_status_over_name;
                      var mqtt_status_data_name:any = device_event[key].mqtt_status_data_name;
                      var mqtt_act_relay_name:any = device_event[key].mqtt_act_relay_name;
                      var mqtt_control_relay_name:any = device_event[key].mqtt_control_relay_name;
                      var action_name:any = device_event[key].action_name; 
                      var subject:any = device_event[key].action_name; 
                      var mqtt_data_value:any = device_event[key].mqtt_data_value;
                      var mqtt_data_control:any = device_event[key].mqtt_data_control;
                      var mqtt_control_on:any = device_event[key].mqtt_control_on;
                      var mqtt_control_off:any = device_event[key].mqtt_control_off;
                      var mqttrs:any = await this.mqttService.getdevicedataAll(mqtt_data_value); 
                      var configdata:any = device_event[key].configdata;
                      var mqtt_data:any = mqttrs['data'];
                      var mqtt_timestamp:any = mqttrs['timestamp'];
                      var timestamp:any = mqttrs['timestamp']; 
                      var mqttrs_count:any=mqtt_data.length; 
                      ...
                      var mqtt_objt_data = Object.values(obj);
                      var mqtt_count:any=mqtt_objt_data.length;
                      var mqtt_status_data_name = device_event[key].mqtt_status_data_name;
                      let obj2: any = [];
                      try {
                        obj2 = JSON.parse(mqtt_status_data_name);
                      } catch (e) {
                ...
                var merged = format.mapMqttDataToDeviceV2([val], mqtt)[0];
                /******************/
                var status_warning:any = device_event[key].status_warning;
                var recovery_warning:any = device_event[key].recovery_warning;
                var status_alert:any = device_event[key].status_alert;
                var recovery_alert:any = device_event[key].recovery_alert; 
                /******************/
                var sensor_value_data:any = merged.value_data;
                var sensor_value_alarm:any =merged.value_alarm;
                var sensor_value_relay:any =merged.value_relay;
                var sensor_value_control_relay:any =merged.value_control_relay;
                /******************/    
                var email_alarm:any = device_event[key].email_alarm;
                var line_alarm:any = device_event[key].line_alarm;
                var telegram_alarm:any = device_event[key].telegram_alarm;
                var sms_alarm:any = device_event[key].sms_alarm;
                var nonc_alarm:any = device_event[key].nonc_alarm;
                var event:any = device_event[key].event;
                /******************/  
                var event:any = device_event[key].event;
                
                var filter_useractive:any = {status:1} 
                var useractive: any = await this.UsersService.useractive(filter_useractive);    
                ...
                */
                if(type_id==1){ 
                              ...
                              if(sensor_value_data>=status_warning){
                                  var subject:any = alarm_action_name+' Warning Device: '+device_name+' value: '+sensor_value_data;  
                                  var content:any = alarm_action_name+' Warning  Device: '+device_name+' value: '+sensor_value_data;  
                              }else if(sensor_value_data>=status_alert){
                                  var subject:any = alarm_action_name+' Alarm Device: '+device_name+' value: '+sensor_value_data;  
                                  var content:any = alarm_action_name+' Alarm Device: '+device_name+' value: '+sensor_value_data;  
                              }else if(sensor_value_data<=recovery_warning){
                                  var subject:any = alarm_action_name+' Recovery Warning Device: '+device_name+' value: '+sensor_value_data;  
                                  var content:any = alarm_action_name+' Recovery Warning Device: '+device_name+' value: '+sensor_value_data;  
                              }else if(sensor_value_data<=recovery_alert){
                                  var subject:any = alarm_action_name+' Recovery Alarm ;  Device: '+device_name+' value: '+sensor_value_data;  
                                  var content:any = alarm_action_name+' Recovery Alarm Device: '+device_name+' value: '+sensor_value_data;  
                              }
                ...
                for (const [k, v] of Object.entries(useractive)) {     
                        ...
                        useractive_arr.push(user_arr);
                            ...
                            }else if(type_id!=1 && email_alarm==1){
                              if(sensor_value_alarm==0){
                                    let ResultData: any = await this.settingsService.sendEmail(email, subject,content);
                              } 
                            }  
            ...
            const DataRs: any = { 
                      ...
                      device_event_control:device_event_control,
                      device_alarm:device_event2,
        }
      ...
      for (const [key, va] of Object.entries(ResultData)) { 
        ...
        var action_name:any=ResultData[key].action_name; 
            ...
            for (const [key, val] of Object.entries(device_data)) {     
                ...
                var event:any = device_data[key].event;
                /******************/   
                var alarm_action_name:any = device_data[key].action_name;
                var alarm_event:any = device_data[key].event;
                var alarm_status:any = device_data[key].status;
                /*----------------------*/
                      var action_name:any = device_data[key].action_name; 
                      var mqtt_data_value:any = device_data[key].mqtt_data_value;
                      var mqtt_data_control:any = device_data[key].mqtt_data_control;
                ...
                var setdata_chk: any = {};
                    ...
                    setdata_chk.status = status;  
                    setdata_chk.event = event;  
                    setdata_chk.date = date_now;   
                    // setdata_chk.alarm_type = alarm_type; 
                    var log_alarm_count :any= await this.settingsService.count_alarmprocesslog(setdata_chk);
 

                /*
                  var setdata_chk: any = {};
                  setdata_chk.alarm_action_id = alarm_action_id;  
                  //count_alarmprocesslog
                  var log_alarm_count :any= await this.settingsService.count_alarmprocesslog(setdata_chk);
                  var setdata: any = {};
                  setdata.alarm_action_id = alarm_action_id;  
                  await this.settingsService.create_alarmprocesslog(setdata);  
                  await this.settingsService.update_alarmprocesslog(setdata);   
                */
