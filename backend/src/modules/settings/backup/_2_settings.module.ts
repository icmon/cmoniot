...
*/
var MAIL_HOST :string= process.env.MAIL_HOST || 'smtp.gmail.com' || "172.29.16.52";
var MAIL_PORT :number= Number(process.env.MAIL_PORT) || 465 || 587;
var MAIL_USERNAME :string= process.env.MAIL_USERNAME || "icmon0955@gmail.com" || "strux.ware";
var MAIL_PASSWORD :string= process.env.MAIL_PASSWORD || "ccwaijtieoujbojk" || "baac@123";
var FROM_EMAIL_USER :string= "strux";
var FROM_EMAIL :string= "<strux.ware@inbaac.com>";
console.log(`-----------settings.module----------`);
console.log(`MAIL_HOST=>` + MAIL_HOST);
console.log(`MAIL_PORT=>` + MAIL_PORT);
console.log(`MAIL_USERNAME=>` + MAIL_USERNAME);
console.log(`MAIL_PASSWORD=>` + MAIL_PASSWORD);
console.log(`FROM_EMAIL_USER=>` + FROM_EMAIL_USER);
