...
$api_updatealarm = $this->config->item('api_url') . 'settings/updateinfluxdb';
                ...
                <form id="alarmForm">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h3 class="card-title mb-0">Edit influxdb</h3>
                            <div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-2">
                                <label class="form-label" for="buckets">buckets</label>
    ...
    fetch(api_url, {
        ...
        .then(resp => {
            if (resp.payload && resp.payload.data && resp.payload.data.length > 0) {
                ...
                document.getElementById('influxdb_id').value = data.influxdb_id || '';
                document.getElementById('influxdb_name').value = data.influxdb_name || '';
                document.getElementById('host').value = data.host || '';
                document.getElementById('port').value = data.port || '';
                document.getElementById('username').value = data.username || '';
                document.getElementById('password').value = data.password || '';
                document.getElementById('token_value').value = data.token_value || '';
                document.getElementById('buckets').value = data.buckets || '';
            }
        })
        .catch(error => {
...
document.getElementById('alarmForm').addEventListener('submit', function(e) {
    ...
    const formData = {
        influxdb_id: document.getElementById('influxdb_id').value,
