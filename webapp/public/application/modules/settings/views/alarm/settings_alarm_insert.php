...
$api_update_add= $this->config->item('api_url') . 'settings/createalarmDevice';
...
// echo '<br> api_update_add=>'.$api_update_add;
...
var api_update_add = <?php echo json_encode($api_update_add); ?>;
