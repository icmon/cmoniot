...
$api_url = $this->config->item('api_url') . 'settings/listnoderedpaginate?nodered_id=' . $nodered_id;
$api_updatenodered = $this->config->item('api_url') . 'settings/updatenodered';
...
var api_updatenodered = <?php echo json_encode($api_updatenodered); ?>;
...
console.log("api_updatenodered:", api_updatenodered);
                ...
                <form id="noderedForm">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h3 class="card-title mb-0">Edit nodered</h3>
                            <div>
    ...
    fetch(api_url, {
        ...
        .then(resp => {
            if (resp.payload && resp.payload.data && resp.payload.data.length > 0) {
                ...
                document.getElementById('nodered_id').value = data.nodered_id || '';
                document.getElementById('nodered_name').value = data.nodered_name || '';
                document.getElementById('host').value = data.host || '';
                document.getElementById('port').value = data.port || '';
                document.getElementById('routing').value = data.routing || '';
...
document.getElementById('noderedForm').addEventListener('submit', function(e) {
    ...
    */
    ...
    const formData = {
        nodered_id: document.getElementById('nodered_id').value,
