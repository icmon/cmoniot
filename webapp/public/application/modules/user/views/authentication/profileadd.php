...
<body>
    ...
    <div class="page page-center">
        <div class="container container-tight py-4">
            ...
            <?php ######################?>
            <form class="card card-md" action="<?php echo base_url('user/profileadddb');?>" method="post"
                autocomplete="off" novalidate id="profileaddFrom">
                <div class="card-body">
            ...
            <div class="text-center text-secondary mt-3">
                Already have account? <a href="<?php echo base_url('user/dashboard');?>"
    ...
    /****************************/
    document.addEventListener('DOMContentLoaded', function() {
        const form = document.getElementById('profileaddFrom');
        ...
        form.addEventListener('submit', function(e) {
            ...
            if (isUsernameValid && isEmailValid && isPasswordValid && isConfirmPasswordValid &&
                isAgreeValid) {
                // 1. เก็บข้อความเดิมของปุ่มไว้ก่อน
                const originalBtnText = submitBtn.innerHTML;

                // 2. ปิดการใช้งานปุ่มและแสดงสถานะกำลังโหลด
                ...
                // ใช้ setTimeout เพื่อจำลองการส่งข้อมูล หรือรอให้ผู้ใช้เห็นสถานะ
                setTimeout(() => {
                    form.submit();
                    // หมายเหตุ: หากการส่งข้อมูลล้มเหลว (เช่น ในอนาคตถ้าใช้ AJAX)
                    // ควรจะคืนค่าปุ่มกลับสู่สถานะเดิม
