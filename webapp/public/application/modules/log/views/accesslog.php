...
$option=$input['option'];
$api_url= base_url('user/api/apilistuserlogget').'?log_type_id=&option='.$option.'&';
...
<?php $this->load->view('log/pagewrapper_singinlog'); ?>
<div class="page-body">
    <?php  /*****body**********/  ?>
    <div class="card-body">
        <div class="card">
        ...
        columns: [{
            ...
            },
            {
                ...
                render: function(data, type, row, meta) {
                    ...
                    return `
                        <a href="<?php echo base_url('log');?>/detail?id=${row[0]}" class="btn btn-sm btn-info me-1"><?php echo $this->lang->line('c_detail');?></a>
