    ...
    try {
        ...
        if (data && data.payload) {
            data.payload.forEach((item, idx) => {
                const row = `<tr>   
                                    <td> 
                                             <a href="<?php echo base_url('settings/device').'?bucket=';?>${item.mqtt_bucket}&mqtt_id=${item.mqtt_id}"> ${item.mqtt_name}   </a> 
                                              
                                              </td>
                                    <td><a href="<?php echo base_url('settings/device').'?bucket=';?>${item.mqtt_bucket}&mqtt_id=${item.mqtt_id}"> ${item.device_name} </a> </td>
                                    <td> <a href="<?php echo base_url('settings/device').'?bucket=';?>${item.mqtt_bucket}&mqtt_id=${item.mqtt_id}"> ${item.sensor_data_name}  </a> </td>
                                     <td><a href="<?php echo base_url('settings/device').'?bucket=';?>${item.mqtt_bucket}&mqtt_id=${item.mqtt_id}"> ${item.timestamp}</a> </td>
                                </tr>`;
