...
<div class="page-body">
    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
            ...
            $this->load->view('dashboard/dashboard3_chart_fan_set_top_sensor'); 
            ?>
            <?php ######## card_box_2?>
            <?php 
           # $this->load->view('dashboard/chart_fan_set_top_sensor_card_loop_type2');
            $this->load->view('dashboard/chart_fan_set_top_sensor_card_loop_type2_v2');
            ?>
            <?php #########################chart-fan################################ ?>
        </div>
