...
float Analog1;
float Analog2;
float AnalogMin = 350;   //ค่าน้อยกว่า x = power off
...
const long ledInterval = 500; // 1 นาที
bool ledState = false;
...
//********************
      ...
      if(ContRelay1 == 1){
      Check_fan_NO_Alarm1();   //  output AlarmFan1 = 0/1 , AlarmFan1 = 0/1
      ActFan1=1;
      }
      else{ActFan1=0;}

      if(ContRelay2 == 1){
      Check_fan_NO_Alarm2();   //  output AlarmFan2 = 0/1 , AlarmFan2 = 0/1
      ActFan2=1;
      }
      else{ActFan2=0;}      
   ...
   if(ActFan1==0)
   {
 //    Serial.println("ActFan1 :OFF");
   }else{
//    Serial.println("ActFan1 :ON");
    }
   if(StatusFan1_Overload==0)
   {
//    Serial.println("StatusFan1_Overload :Normal");
   }else{
//    Serial.println("StatusFan1_Overload :Alarm");
    }
    if(ActFan2==0)
   {
//     Serial.println("ActFan2 :OFF");
   }else{
//    Serial.println("ActFan2 :ON");
    }
   if(StatusFan2_Overload==0)
   {
//    Serial.println("StatusFan2_Overload :Normal");
   }else{
//    Serial.println("StatusFan2_Overload :Alarm");
    }
