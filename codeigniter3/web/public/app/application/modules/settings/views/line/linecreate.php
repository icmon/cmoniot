...
$api_createline = $this->config->item('api_url') . 'settings/createline';
...
var api_createline = <?php echo json_encode($api_createline); ?>;
var tokens = <?php echo json_encode($token); ?>;
var home_url = <?php echo json_encode($home_url); ?>;

console.log("api_url:", api_url);
console.log("api_createline:", api_createline);
                ...
                <form id="createlineForm">
                    <div class="card">
                        <div class="card-header d-flex align-items-center justify-content-between">
                            <h3 class="card-title mb-0">Add line</h3>
                            <div>
...
document.getElementById('createlineForm').addEventListener('submit', function(e) {
    ...
    if (!validateDevicecreatelineForm()) return;
    ...
    const formData = {
        ...
        grant_type: document.getElementById('grant_type').value.trim(),
...
function validateDevicecreatelineForm() {
    let valid = true;
    let messages = [];
