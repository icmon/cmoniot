    ...
    <div class="container-xl">
        <div class="row row-deck row-cards">
            ...
            # $this->load->view('dashboard/chart_fan_set_top_sensor_v2'); 
             $this->load->view('dashboard/dashboard1_chart_fan_set_top_sensor'); 
            
            ?>
            <?php #########################chart-active-users-top################################ ?>
            <?php #########################chart-fan################################ ?>
            <?php # $this->load->view('dashboard/chart_fan_set_sensor_loop');  ?>
            <?php  $this->load->view('dashboard/dashboard1_chart_fan_set_sensor_loop');  ?>
            <?php #########################chart-fan################################ ?>
        </div>
