<!-- BEGIN PAGE BODY -->
<?php   $this->load->view('demo/pagewrapper'); ?>
<div class="page-body">
    <?php 
    /*****body**********/
    ?>
                    ...
                    <div class="card-body">
                        <div class="row gy-3">
                            ...
                            <div class="col-12 col-sm-auto d-flex justify-content-center">
                                <a href="<?php echo base_url('assets');?>/illustrations">
                        ...
                        <table class="table table-vcenter">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap text-secondary">28 พ.ย. 2019</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap text-secondary">27 พ.ย. 2019</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap text-secondary">26 พ.ย. 2019</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-nowrap text-secondary">25 พ.ย. 2019</td>
                                </tr>
                            ...
                            <div class="col-10">
                                ...
                                <div class="markdown text-secondary">
                                    ...
                                    <a href="https://tabler.io/icons" target="_blank"
                                        rel="noopener">tabler.io/icons</a>,
                                    download any of the 5880 icons in SVG, PNG or&nbsp;React and use them in
                            ...
                            <div class="col-7 offset-5 text-primary">
                                ...
                                <div class="mt-4">
                                    <button class="btn w-100 pe-none" type="button">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="currentColor" class="icon text-pink icon-3">
                                            <path
...
<?php 
     ...
     $this->load->view('demo/data_js_d2');
     $this->load->view('demo/page_script_js');
