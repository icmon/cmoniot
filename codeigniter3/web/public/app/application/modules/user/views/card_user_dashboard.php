...
$(document).ready(function() {
    $('#example').DataTable({
		...
		/*
				{
					"uid": "d95b5588-3880-4f05-b661-6a111c860c5e",
					"role_id": 2,
					"email": "icmon0955@gmail.com",
					"username": "icmons",
					"firstname": null,
					"lastname": null,
					"fullname": null,
					"nickname": null,
					"idcard": null,
					"lastsignindate": "2025-07-03 02:11:07",
					"status": 1,
					"active_status": 1,
					"network_id": null,
					"remark": "alexsomsap@gmail.com",
					...
					"avatar": null,
					"loginfailed": 0,
					"mobile_number": "0844387246",
					"lineid": "alex.somsap",
					"public_notification": 0,
					"sms_notification": 1,
					"email_notification": 0,
					"line_notification": 0,
					"phone_number": "0844387246",
					"rolename": "Administrator",
					"role_type_id": 2,
					"permision_name": "Admin Level",
					"permision_detail": "Admin access",
					"permision_created": "2021-05-09T12:52:04.000Z",
					"permision_updated": "2021-05-09T12:52:09.000Z",
					"permision_insert": 1,
					"permision_update": 1,
					"permision_delete": 1,
					"permision_select": 1,
					"permision_log": 1,
					"permision_config": 0,
					"permision_truncate": 0,
					"createddate": "2025-07-03 02:11:07",
					"updateddate": "2025-08-24 17:49:30",
					"deletedate": "2025-07-03 02:11:07"
				}
		...
		*/
        columns: [{
            ...
            },
            {
                ...
                className: "text-center", // จัดกึ่งกลาง
                render: function(data, type, row, meta) {
                    const email_notification = parseInt(data, 1); // แปลงเป็นตัวเลข
					// console.log('data=>');
        			// console.info(data);
                    if (type ===
                        'display') { // ใช้เงื่อนไขนี้เพื่อให้ render เฉพาะตอนแสดงผล
