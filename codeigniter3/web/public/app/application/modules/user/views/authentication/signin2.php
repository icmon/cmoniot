        ...
        <div class="container container-tight py-4">
            ...
            <div class="text-center">
                <a href="<?php echo $base_url;?>/lang/language?lang=english&uri=<?php print(uri_string()); ?>"> <img
                        ...
                        title="<?php  echo $this->lang->line('english');?>"> </a>
                <?php ###########################################?>
                <a href="<?php echo $base_url;?>/lang/language?lang=thai&uri=<?php print(uri_string()); ?>"><img
            ...
            <div class="card card-md">
                <div class="card-body">
                    ...
                    <form action="<?php echo base_url('user/signindbotp');?>" method="post" autocomplete="off"
                        novalidate>
                        <div class="mb-3">
                        ...
                        <div class="input-group input-group-flat">
                            <input type="password" name="password" value="" class="form-control" id="passwordField"
                                placeholder="<?php echo $this->lang->line('password');?>" autocomplete="on" required>
                            ...
                            <span class="input-group-text">
                                <a href="#" class="link-secondary" title="Show password" data-bs-toggle="tooltip"
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        ...
                                        stroke-linejoin="round" class="icon icon-1" id="eyeIcon">
                                    ...
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                        fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                        stroke-linejoin="round" class="icon icon-1" id="eyeOffIcon"
                                        style="display: none;">
                        ...
                        <!-- <div class="mb-2">
                            <label class="form-check">
                                ...
                                <span class="form-check-label"><a href="<?php echo base_url('/user/signin');?>">Remember
                                        me on this
                                        device</a></span></span>
                            </label>
                        </div> -->
