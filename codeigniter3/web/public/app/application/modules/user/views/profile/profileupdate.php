        ...
        <div class="card">
            <div class="row g-0">
                ...
                <div class="col-12 col-md-10 d-flex flex-column">
                    <?php ############################# ?>
                    <?php ############################# ?>
                    <form class="card card-md" action="<?php echo base_url('user/profileupdatedb2');?>" method="post"
                        autocomplete="off" novalidate id="userupdateForm" onsubmit="return validateForm()">
                        <div class="card-body">
                            <h2 class="mb-4">My Account</h2>
                            <!-- <h3 class="card-title">Profile Details</h3> -->
                            <?php ################################?>
                            <h3 class="card-title mt-4 col-3 col-form-label required">Change email
                                <?php #echo $this->lang->line('email_user');?></h3>
                                ...
                                <div class="row g-2">
                                    <div class="col-md">
                                        ...
                                        <input type="hidden" id="email" name="email" class="form-control"
                                            value="<?php echo $email;?>" placeholder="Enter email"> <?php echo $email;?>
                                    </div>
                                </div>
                            </div>
                            <hr>
                                ...
                                <select class="form-select" id="role_id" name="role_id">
                                    ...
                                    <?php 
                                        foreach ($listroles as $key=> $value) {
                                            $role_type_id=$value['role_type_id'];
                                            $name=$value['name']; 
                                    ?>
                                    <option value="<?php echo $role_type_id;?>"
                                        <?php if($profile['role_id']==$role_type_id){ echo ' selected="selected"'; } ?>>
                            ...
                            <div class="row g-3">
                                <div class="col-md">
                                    <div class="form-label col-3 col-form-label required">
                                        <?php echo $this->lang->line('username');?></div>
                            ...
                            <div class="row g-3">
                                <div class="col-md">
                                    <div class="form-label col-3 col-form-label required">
                                        <?php echo $this->lang->line('mobile_number');?></div>
                                ...
                                <div class="col-md">
                                    <div class="form-label col-3 col-form-label required">
                                        <?php echo $this->lang->line('phone_number');?></div>
                                ...
                                <div class="col-md">
                                    <div class="form-label col-3 col-form-label required">
                                        <?php echo $this->lang->line('lineid');?></div>
                            ...
                            <!-- <div class="mb-3">
                                <label
                                    class="form-label col-3 col-form-label required"><?php echo $this->lang->line('password');?></label>
                            ...
                            <?php ######################### class="col-3 col-form-label required"#######?>
                            <!-- <div class="mb-3">
                                <label
                                    class="form-label col-3 col-form-label required"><?php echo $this->lang->line('confirm_password');?></label>
                                <div class="input-group input-group-flat">
                                    ...
                                    <div>
                                        <label class="row">
                                            <span class="col">SMS Notifications : <a
                                                    href="#"><?php echo $mobile_number;?> </a></span>
                                            <span class="col-auto">
                                                <label class="form-check form-check-single form-switch">
