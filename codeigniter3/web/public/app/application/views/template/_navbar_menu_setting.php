...
?>
 ...
 active<?php } ?>" href="<?php echo base_url('settings/influxdb');?>">
             ...
             <div class="dropdown-menu-column">
                 ...
                 <a class="dropdown-item <?php if($this->uri->segment(1)=='settings' and $this->uri->segment(2)=='line'){ ?>
 active<?php } ?>" href="<?php echo base_url('settings/line');?>">
                     <?php # echo $this->lang->line('navbar_menu_token');?>
                     Line
                 </a>
                 ...
                 <a class="dropdown-item <?php if($this->uri->segment(1)=='settings' and $this->uri->segment(2)=='email'){ ?>
 active<?php } ?>" href="<?php echo base_url('settings/email');?>">
                     <?php # echo $this->lang->line('navbar_menu_token');?>
                     Email
                 </a>
             </div>
